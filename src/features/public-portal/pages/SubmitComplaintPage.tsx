...
const complaintCategories: Array<{
  ...
  },
  {
    ...
    helper: { en: 'General civic service feedback or reassignment requests', ta: 'பொது சேவை கருத்து அல்லது உரிய அணிக்கு மாற்ற வேண்டுகோள்' },
    icon: 'file',
  },
]
...
const submitCopy = {
  ...
  ta: {
    ...
    heroTitle: 'பொது சேவை குறையை தெளிவாகவும் முழுமையாகவும் பதிவு செய்யவும்.',
    heroBody:
    ...
    dangerBody:
      'தீ, பொலிஸ், ஆம்புலன்ஸ், மீட்பு அல்லது உயிர் பாதுகாப்பு அவசரம் ஏற்பட்டால் முதலில் உரிய அவசர சேவையைத் தொடர்பு கொள்ளவும். இம்மையம் பொது சேவை தொடர்பான தொடர்ச்சித் நடவடிக்கைகளுக்காக மட்டுமே.',
    ...
    urgency: 'அவசர நிலை',
    urgencyHelp: 'மிக அருகான நிலையைத் தேர்வு செய்யவும். பரிசீலனையின் பின்னர் அலுவலர்கள் மாற்றலாம்.',
    ...
    formNote: 'உடனடி அபாயம் இருந்தால் முதலில் அவசர சேவையைத் தொடர்பு கொள்ளவும். இம்மையம் பொது சேவை தொடர்பான தொடர்ச்சிக்காக மட்டுமே.',
    back: 'முந்தையது',
    next: 'அடுத்து',
  },
}
