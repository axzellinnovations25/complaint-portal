...
const primaryNotices: Array<{
...
}> = [
  {
    ...
    detail: {
      ...
      ta: 'இந்த மையம் பொதுச் சேவை தொடர்பான தொடர்ச்சித் நடவடிக்கைகளுக்காக மட்டுமே. தீ, பொலிஸ், ஆம்புலன்ஸ் அல்லது உயிர் பாதுகாப்பு அவசரம் ஏற்பட்டால் முதலில் உரிய அவசர சேவையைத் தொடர்பு கொள்ளவும்.',
    },
    icon: 'alert',
    tone: 'rose',
  },
...
const noticesCopy = {
  ...
  ta: {
    ...
    summaryBody: 'இம்மையம் பொதுச் சேவை முறைப்பாடுகளுக்காக மட்டுமே; உடனடி அபாயங்கள் அல்லது அவசர கோரிக்கைகளுக்காக அல்ல.',
    summaryBullets: ['அவசர நிலைகள் உரிய அவசர சேவைக்கு', 'இட விவரம் கள அணிக்கு உதவும்', 'குறிப்பு எண் கண்காணிப்பிற்கு உதவும்'],
    boundaryEyebrow: 'முக்கியமான எல்லை',
    boundaryTitle: 'இந்த மையம் அவசர சேவைகளுக்கான மாற்று அல்ல.',
    boundaryBody:
      'உயிர், சொத்து அல்லது பொது பாதுகாப்பிற்கு உடனடி அபாயம் இருந்தால், முதலில் சம்பந்தப்பட்ட அவசர சேவையைத் தொடர்பு கொள்ளவும். இம்மையம் அவசரமற்ற பொதுச் சேவை தொடர்பான தொடர்ச்சித் நடவடிக்கைகளுக்காக மட்டுமே பயன்பட வேண்டும்.',
    ...
    beforeBody:
      'தரமான முறைப்பாடு குறிப்பானதாகவும், பொதுச் சேவையுடன் தொடர்புடையதாகவும், கள அலுவலர் அல்லது துறைத் தலைவர் எளிதில் ஒதுக்கக்கூடியதாகவும் இருக்கும்.',
    goodChecklist: 'தரமான முறைப்பாட்டிற்கான சரிபார்ப்பு',
    notForPortal: 'இந்த மையத்தில் பதிவு செய்ய வேண்டாதவை',
    beforeSubmitItems: [
      'இது பிரதேச சபையின் பொதுச் சேவை பொறுப்பிற்குள் வருகிறதா என்பதை உறுதி செய்யவும்.',
    ...
    notForPortalItems: [
      ...
      'பொதுச் சேவை பிரச்சினை அல்லாத தனிப்பட்ட தகராறுகள்',
