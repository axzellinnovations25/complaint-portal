...
(async () => {
  ...
  await pg1.screenshot({ path: 'desktop-en.png', fullPage: false });
  console.log('English desktop done');
  ...
  await pg2.screenshot({ path: 'desktop-ta.png', fullPage: false });
  console.log('Tamil desktop done');
