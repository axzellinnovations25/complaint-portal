...
const portalBoundaries = [
  ...
  {
    title: { en: 'Use the closest category', ta: 'மிக அருகான வகையைத் தேர்ந்தெடுக்கவும்' },
...
const servicesCopy = {
  ...
  ta: {
    ...
    closestCategory: 'மிக அருகான வகையைத் தேர்வு செய்தால் போதுமானது',
    ...
    commonBody:
      'குடிமக்கள் பொதுவாக விவரிக்கும் பிரச்சினைகளின் அடிப்படையில் இவ்வகைகள் அமைக்கப்பட்டுள்ளன. மிக அருகான ஒன்றைத் தேர்ந்தெடுத்தால் செயற்பாட்டு அணி அதை உரிய அலுவலர் அல்லது துறைக்கு ஒதுக்கும்.',
