...
const trackCopy = {
  ...
  ta: {
    ...
    demoLabel: 'இந்த மாதிரி எண்ணை முயற்சி செய்யவும்',
    privacyNote: 'அடையாளம் வெளிப்படுத்தாத முறைப்பாடாக இருந்தால் குறிப்பு எண்ணை தனிப்பட்ட முறையில் பாதுகாப்பாக வைத்திருக்கவும்.',
    smsNote: 'பதிவு செய்யும் போது தொலைபேசி எண் வழங்கப்பட்டிருந்தால் மட்டுமே SMS புதுப்பிப்புகள் கிடைக்கும்.',
    guideEyebrow: 'நிலை விளக்கம்',
    guideTitle: 'ஒவ்வொரு நிலையின் பொருள்',
